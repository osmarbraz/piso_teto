...
public class Principal {
     ...
     *
     * @param a Numero real a ser cálculado o teto.
     * @param b Numero real a ser cálculado o teto.
     ...
     * tal que i<=x<i+1. Ex. O piso de 5/2 = 2.5 é 2
     *
     * Em java pode ser utilizando Math.floor(double)
     *
     * @param a Numero real a ser calculado o piso.
     * @param b Numero real a ser calculado o piso.
     ...
     *  
     * Em outras palavras, o piso de x é o único número inteiro i
     * tal que i<=x<i+1. Ex. O piso de 2.5 é 2
     *
     * Em java pode ser utilizando Math.floor(double)
     *
